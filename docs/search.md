...
If you use the theme as a gem, you must initialize the search by running this `rake` command that comes with `azurecoe`:

```bash
$ bundle exec azurecoe rake search:init
```
